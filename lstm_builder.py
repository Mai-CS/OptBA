...
ailments_data = pd.read_csv(
    "/home/mai.kassem/Documents/ML701-AilmentClassification/data/aug_ailments.csv",
    encoding="ISO-8859-1",
)
...
X = pad_sequences(train_sequences, maxlen=max_length, padding="post", truncating="post")
...
def evaluate_model(model):
    ...
    for train, test in kfold.split(X, y):
        ...
        recall_list.append(metrics.recall_score(y[test], y_pred, average="weighted"))
        f1_score_list.append(metrics.f1_score(y[test], y_pred, average="weighted"))
